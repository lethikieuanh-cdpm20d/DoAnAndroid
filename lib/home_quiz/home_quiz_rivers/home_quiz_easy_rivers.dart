...
import 'package:flutter_application_1/db_connect/db_connect_rivers/db_connect_rivers.dart';
...
class QuizEasyRivers extends StatefulWidget {
  const QuizEasyRivers({Key? key}) : super(key: key);
...
class _QuizEasyState extends State<QuizEasyRivers> {
  var db = DBconnectEasyRivers();
