...
class QuizEasyHealthy extends StatefulWidget {
  const QuizEasyHealthy({Key? key}) : super(key: key);
...
class _QuizEasyState extends State<QuizEasyHealthy> {
  var db = DBconnectEasyHealthy();
