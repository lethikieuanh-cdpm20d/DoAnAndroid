...
import 'package:flutter_application_1/db_connect/db_connect_music/db_connect_easy_music.dart';
...
class QuizEasyMusic extends StatefulWidget {
  const QuizEasyMusic({Key? key}) : super(key: key);
...
class _QuizEasyState extends State<QuizEasyMusic> {
  var db = DBconnectEasyMusic();
