...
class QuizEasyEnviroment extends StatefulWidget {
  const QuizEasyEnviroment({Key? key}) : super(key: key);
...
class _QuizEasyState extends State<QuizEasyEnviroment> {
  var db = DBconnectEasyEnviroment();
