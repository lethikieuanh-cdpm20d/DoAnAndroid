...
import 'package:flutter_application_1/db_connect/db_connect_history/db_connect_easy_history.dart';
...
class QuizEasyHistory extends StatefulWidget {
  const QuizEasyHistory({Key? key}) : super(key: key);
...
class _QuizEasyState extends State<QuizEasyHistory> {
  var db = DBconnectEasyHistory();
