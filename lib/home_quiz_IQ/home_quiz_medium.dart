...
import 'package:flutter_application_1/db_connect_IQ/db_connect_medium_IQ.dart';
...
class QuizMediumIQ extends StatefulWidget {
  const QuizMediumIQ({Key? key}) : super(key: key);
...
class _QuizMediumState extends State<QuizMediumIQ> {
  var db = DBconnectMediumIQ();
